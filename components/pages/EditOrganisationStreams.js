import { 
  ...
  const EditOrganisationStreams = ({match}) => {
    ...
    useEffect(() => {
      ...
      return (
          <IonPage >
        <IonHeader >
          <title>Edit Organisation Streams - {username}</title>
                        ...
                        <div className="bg-light mb-8 grid grid-cols-1 lg:gap-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
                            ...
                            <section className="col-span-2">
                              <div className="px-4 py-5 grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-6">
                                ...
                                <div className="">
                                  {organisation.stream_twitch && (
                                    <CardTwitch
                                    twitchId={organisation.stream_twitch}
                                    />
                                  )}
                                </div>
                              </div>
  ...
  export default EditOrganisationStreams