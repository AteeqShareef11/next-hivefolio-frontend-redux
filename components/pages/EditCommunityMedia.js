import { 
  ...
  const EditCommunityMedia = ({match}) => {
...
const handleEditSubmit = async (event) => {
  ...
  window.location.reload();
    ...
    fetchCommunity()
      ...
      return (
          <IonPage >
        <IonHeader >
          <title>Edit Community Media - {username}</title>
                            ...
                            <div className="px-4 py-5">
                              <div className="">
                                <div className=" relative rounded-full overflow-hidden mb-8">
                                  ...
                                  style={{
                                      backgroundImage: `url(${community.image_profile && community.image_profile.url})`
                                  }}
                            ...
                            <div className="px-4 py-5">
                              <div className="flex m-auto w-full">
                                <div className="w-full">
                                  ...
                                  { community.image_background ? (
                                      <img className="relative w-full h-80 bg-no-repeat bg-cover overflow-hidden " 
                                      style={{
                                          backgroundImage: `url(${community.image_background && community.image_background.url})`
                                      }}
                                      />
                                  ) : (
                                    <div
                                    className="bg-white rounded-3xl border-none p-4 sm:w-full h-80 bg-cover bg-no-repeat"
                        ...
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { community.image_feature_1 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${community.image_feature_1 && community.image_feature_1.url})`
                                  }}
                                  />
                              ) : (
                                <div
                    ...
                    <div className="bg-light mb-8 grid grid-cols-1 lg:gap-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
                      ...
                      <section className="col-span-2">
                        ...
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { community.image_highlight_1 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${community.image_highlight_1 && community.image_highlight_1.url})`
                                  }}
                                  />
                              ) : (
                                <div
                      ...
                      <div className="px-4 py-5">
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { community.image_highlight_2 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${community.image_highlight_2 && community.image_highlight_2.url})`
                                  }}
                                  />
                              ) : (
                                <div
                      ...
                      <div className="px-4 py-5">
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { community.image_highlight_3 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${community.image_highlight_3 && community.image_highlight_3.url})`
                                  }}
                                  />
                              ) : (
                                <div
                      ...
                      <div className="px-4 py-5">
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { community.image_highlight_4 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${community.image_highlight_4 && community.image_highlight_4.url})`
                                  }}
                                  />
                              ) : (
                                <div
  ...
  export default EditCommunityMedia