import { 
  ...
  import OnboardingTeam01 from '../ui/Onboarding/OnboardingTeam01';
  ...
  import { fetchTeamId } from '../redux/actions/coreActions';
  ...
  const { name, username, games, members, image_profile, image_background, type_team } = selectedTeam;
  
  const adminId = selectedTeam.admins?.find((person) => {
      return person.id === user.id;
  })
  
  const steps = [
    //{component: Login, label: "Login"}, 
    {component: OnboardingTeam01, label: "Sign Up"},
    ...
    useEffect(() => {
      ...
      if(user) {
        if(adminId && selectedTeam.boolean_onboarding === true) {
          history.push(`/team/${username}`)
        } else {
          if(!selectedTeam && adminId === undefined) {
    ...
    return (
      ...
      <IonContent fullscreen >
        ...
        <section className="bg-light h-full">
                ...
                <div className='bg-primary text-dark rounded-full text-center text-bold p-2 border-8 border-white border-solid sticky top-2 z-40 m-2 font-bold text-lg max-width'>Onboarding: Team</div>
                    ...
                    <div className='flex h-full mt-8 text-center w-full max-w-xl xs:hidden sm:hidden md:hidden lg:block xl:block'>
                      {page === 0 && (
                        <div className="flex w-full space-y-5 md:pr-16 xs:hidden sm:hidden md:hidden lg:block xl:block items-start">
                          ...
                          <p className="text-xl text-dark w-full">Let's help you setup your team's profile.</p>
                        </div>
                      )}   
                      ...
                      {page === 2 && (
                        <div className="flex w-full space-y-5 md:pr-16 xs:hidden sm:hidden md:hidden lg:block xl:block items-center">
                          <div>
                            ...
                            <p className="text-xl text-dark w-full">Select the team's types</p>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="">
                              <CardGrid
                                ...
                                className="mt-8"
                              >
                                {type_team.sort(() => Math.random() - 0.5).map(type => (
                                  <div
                      ...
                      {page === 3 && (
                        <div className="flex w-full space-y-5 md:pr-16 xs:hidden sm:hidden md:hidden lg:block xl:block items-center">
                          ...
                          <div>
                            ...
                            <p className="text-xl text-dark w-full">Select users to join your team</p>
                          </div>
