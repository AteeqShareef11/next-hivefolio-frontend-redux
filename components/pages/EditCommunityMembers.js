...
import SelectListUsers from '../ui/Community/SelectListUsers';
import SelectListMembers from '../ui/Community/SelectListMembers';
import SelectUsers from '../ui/Community/SelectUsers';
...
const EditCommunityMembers = () => {
  ...
  return (
    <IonPage>
      <IonHeader>
        <title>Edit Community Members - {community.username}</title>
        ...
        <div className="max-width">
          ...
          <main className="relative ">
            <div className="max-w-screen-xl mx-auto pb-6 px-4 sm:px-6 lg:pb-16 lg:px-8">
              ...
              />
              <h3 className="">Community members</h3>
              <TabsHeadlessUi
                tab1title="Members"
                tab1={
                  <SelectListMembers/>
