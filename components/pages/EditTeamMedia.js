...
const EditTeamMedia = ({ match }) => {
  ...
  return (
    <IonPage>
      <IonHeader>
        <title>Edit Team Media - {team.username}</title>
                        ...
                        <div className="">
                          ...
                          {team.image_profile ? (
                              <div
                                ...
                                style={{
                                  backgroundImage: `url(${team.image_profile && team.image_profile.url})`,
                                }}
                                alt={`Profile name ${team.name}`}
                              >
                              </div>
                            ) : (
                              <div
                        ...
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              ...
                              { team.image_background ? (
                                  <img className="relative w-full h-80 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${team.image_background && team.image_background.url})`
                                  }}
                                  />
                              ) : (
                                <div
                          ...
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { team.image_feature_1 ? (
                                  ...
                                  style={{
                                      backgroundImage: `url(${team.image_feature_1 && team.image_feature_1.url})`
                                  }}
                                  />
                              ) : (
                                <div
                          ...
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { team.image_highlight_1 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${team.image_highlight_1 && team.image_highlight_1.url})`
                                  }}
                                  />
                              ) : (
                                <div
                          ...
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { team.image_highlight_2 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${team.image_highlight_2 && team.image_highlight_2.url})`
                                  }}
                                  />
                              ) : (
                                <div
                          ...
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { team.image_highlight_3 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${team.image_highlight_3 && team.image_highlight_3.url})`
                                  }}
                                  />
                              ) : (
                                <div
                          ...
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { team.image_highlight_4 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${team.image_highlight_4 && team.image_highlight_4.url})`
                                  }}
                                  />
                              ) : (
                                <div
