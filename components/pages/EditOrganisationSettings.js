import { 
  ...
  const EditOrganisationSettings = ({match}) => {
   ...
   const handleDelete = async () => {
      ...
      return (
          <IonPage >
        <IonHeader >
          <title>Edit Organisation Settings - {username}</title>
                            ...
                            <IonModal
                              ...
                              <div className="sm:items-start m-8">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left mb-4 w-full">
                                  ...
                                  <div className="mt-2">
                                    ...
                                    <p>Enter your organisation username "{organisation.username}"</p>
                                    <IonItem className="mb-4" >
                                      <IonLabel position="stacked">Write your organisation username {organisation.username}</IonLabel>
                                      <IonInput 
                                    ...
                                    {organisation.username === accountValidate && (
                                      <div className="mt-4">
                                        <p className="mb-4">CAUTION: This will permantely delete your organisation account and you cannot recover it!</p>
                                        <button
                              ...
                              <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <IonToast
                                  ...
                                  message={`Your organisation account ${organisation.username} has been deleted`}
                                  duration={1000}
                                />
                              </div>
  ...
  export default EditOrganisationSettings