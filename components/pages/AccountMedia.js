...
import { fetchUserId } from '../redux/actions/coreActions';
...
const AccountMedia = ({  }) => {
  ...
  const {username, gamertag} = selectedUser;
  ...
  return (
    <IonPage>
      <IonHeader>
        <title>Edit profile Media - {username}</title>
                        ...
                        <div className="">
                          ...
                          {selectedUser.image_profile ? (
                              <div
                                ...
                                style={{
                                  backgroundImage: `url(${selectedUser.image_profile && selectedUser.image_profile.url})`,
                                }}
                            ...
                            {/* <img
                              className="relative rounded-full w-40 h-40 bg-no-repeat bg-cover overflow-hidden"
                              style={{
                                backgroundImage: `url(${
                                  team.image_profile && team.image_profile.url
                                })`,
                              }}
                            /> */}
                        ...
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              ...
                              { selectedUser.image_background ? (
                                  <img className="relative w-full h-80 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${selectedUser.image_background && selectedUser.image_background.url})`
                                  }}
                                  />
                              ) : (
                                <div
                              ...
                              {/* <img
                                className="relative w-full h-80 bg-no-repeat bg-cover overflow-hidden "
                                style={{
                                  backgroundImage: `url(${
                                    team.image_background && team.image_background.url
                                  })`,
                                }}
                              /> */}
                    ...
                    <div className="bg-light mb-8 grid grid-cols-1 lg:gap-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
                      ...
                      <section className="col-span-2">
                        ...
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { selectedUser.image_feature_1 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${selectedUser.image_feature_1 && selectedUser.image_feature_1.url})`
                                  }}
                                  />
                              ) : (
                                <div
                    ...
                    <div className="bg-light mb-8 grid grid-cols-1 lg:gap-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
                      ...
                      <section className="col-span-2">
                        ...
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { selectedUser.image_highlight_1 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${selectedUser.image_highlight_1 && selectedUser.image_highlight_1.url})`
                                  }}
                                  />
                              ) : (
                                <div
                      ...
                      <div className="px-4 py-5">
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { selectedUser.image_highlight_2 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${selectedUser.image_highlight_2 && selectedUser.image_highlight_2.url})`
                                  }}
                                  />
                              ) : (
                                <div
                      ...
                      <div className="px-4 py-5">
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { selectedUser.image_highlight_3 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${selectedUser.image_highlight_3 && selectedUser.image_highlight_3.url})`
                                  }}
                                  />
                              ) : (
                                <div
                      ...
                      <div className="px-4 py-5">
                        <div className="flex m-auto w-full">
                          <div className="w-full">
                            <div className=" relative rounded-lg overflow-hidden w-full mb-8 bg-white">
                              { selectedUser.image_highlight_4 ? (
                                  <img className="relative w-full h-32 bg-no-repeat bg-cover overflow-hidden " 
                                  style={{
                                      backgroundImage: `url(${selectedUser.image_highlight_4 && selectedUser.image_highlight_4.url})`
                                  }}
                                  />
                              ) : (
                                <div
