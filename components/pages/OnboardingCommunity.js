import { 
  ...
  import OnboardingCommunity01 from '../ui/Onboarding/OnboardingCommunity01';
  ...
  import { fetchCommunityId } from '../redux/actions/coreActions';
  ...
  const { name, username, games, members, image_profile, image_background, type_community } = selectedCommunity;
  
  const adminId = selectedCommunity.admins?.find((person) => {
      return person.id === user.id;
  })
  
  const steps = [
    //{component: Login, label: "Login"}, 
    {component: OnboardingCommunity01, label: "Sign Up"},
    ...
    useEffect(() => {
      ...
      if(user) {
        if(adminId && selectedCommunity.boolean_onboarding === true) {
          history.push(`/community/${username}`)
        } else {
          if(!selectedCommunity && adminId === undefined) {
    ...
    return (
      ...
      <IonContent fullscreen >
        ...
        <section className="bg-light h-full">
                ...
                <div className='bg-primary text-dark rounded-full text-center text-bold p-2 border-8 border-white border-solid sticky top-2 z-40 m-2 font-bold text-lg max-width'>Onboarding: Community</div>
                    ...
                    <div className='flex h-full mt-8 text-center w-full max-w-xl xs:hidden sm:hidden md:hidden lg:block xl:block'>
                      {page === 0 && (
                        <div className="flex w-full space-y-5 md:pr-16 xs:hidden sm:hidden md:hidden lg:block xl:block items-start">
                          ...
                          <p className="text-xl text-dark w-full">Let's help you setup your community's profile.</p>
                        </div>
                      )}   
                      ...
                      {page === 2 && (
                        <div className="flex w-full space-y-5 md:pr-16 xs:hidden sm:hidden md:hidden lg:block xl:block items-center">
                          <div>
                            ...
                            <p className="text-xl text-dark w-full">Select the community's types</p>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="">
                              <CardGrid
                                ...
                                className="mt-8"
                              >
                                {type_community.sort(() => Math.random() - 0.5).map(type => (
                                  <div
                      ...
                      {page === 3 && (
                        <div className="flex w-full space-y-5 md:pr-16 xs:hidden sm:hidden md:hidden lg:block xl:block items-center">
                          ...
                          <div>
                            ...
                            <p className="text-xl text-dark w-full">Select users to join your community</p>
                          </div>
