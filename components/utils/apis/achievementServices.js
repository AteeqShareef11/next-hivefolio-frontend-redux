...
//     try {
//       const response = await hivefolioApi.post(`/achievements`, formData, {
//         headers: {
...
//   return async dispatch => {
//     try {
//       const response = await hivefolioApi.put(`/achievements/${id}`, formData, {
//         headers: {
//           // 'content-type': 'multipart/form-data',
...
// export const achievementAddAdmin =
//   (id, userId, users, user, team, teamDataAdmin) => async dispatch => {
//     if (user === team.admins) {
//       setError('Please sign in first');
//       return;
//     }
...
//     try {
//       const response = await hivefolioApi.put(
//         `/achievements/${id}`,
//         data,
...
//     const data = {
//       ...team,
//       type_achievements: team.type_achievements
...
//   async dispatch => {
//     try {
//       const response = await hivefolioApi.delete(
//         `/achievements/${id}`,
