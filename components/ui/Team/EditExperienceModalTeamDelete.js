...
const EditExperienceModalTeamDelete = ({ selectedExperince, showDeleteExperiencesModal, setShowEditExperiencesModal01, setShowDeleteExperiencesModal}) => {
...
export default EditExperienceModalTeamDelete;
