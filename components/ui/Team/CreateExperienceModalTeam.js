...
const CreateExperienceModalTeam = ({ showCreateExperienceModal, setShowCreateExperienceModal, selectedExperince}) => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append('data', JSON.stringify({title: name, description: description, related_teams: [selectedProfileTeam], admins: [admins] }));
...
export default CreateExperienceModalTeam;
