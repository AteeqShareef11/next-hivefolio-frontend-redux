...
/* Components */
import ScoreModalTeam from './ScoreModalTeam';
import EditScoreModalTeam01 from './EditScoreModalTeam01';
...
const CardScoreTeam = ({ userId, username, image_profile, email, gamertag }) => {
