...
/* Components */
import AchievementModalTeam from './AchievementModalTeam';
import EditAchievementModalTeam01 from './EditAchievementModalTeam01';
...
const CardAchievementTeam = ({ userId, username, image_profile, email, gamertag }) => {
      ...
      <div class="flex flex-row bg-light w-full px-6 py-4 whitespace-nowrap">
        <div class="flex justify-between items-center w-full">
          ...
          <div className='flex'>
            ...
            <AchievementModalTeam
              showModal={showModal}
              setShowModal={setShowModal}
            />

            <EditAchievementModalTeam01
...
export default CardAchievementTeam;
