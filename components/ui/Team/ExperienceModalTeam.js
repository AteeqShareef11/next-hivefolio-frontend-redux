...
/* Components */
import EditExperienceModalTeam01 from './EditExperienceModalTeam01';

const ExperienceModalTeam = ({ selectedExperince, showEditExperiencesModal, setShowEditExperiencesModal, showToast1, setShowToast1}) => {
...
export default ExperienceModalTeam;


const ModalContent = ({ description, type_experiences, selectedExperince, selectedProfileTeam, adminId, setShowEditExperiencesModal02 }) => {
  return (
    <>
