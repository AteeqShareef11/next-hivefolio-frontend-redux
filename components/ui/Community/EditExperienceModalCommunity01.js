...
/* Components */
import EditExperienceModalCommunity02 from './EditExperienceModalCommunity02';
import EditExperienceModalCommunityDelete from './EditExperienceModalCommunityDelete';

const EditExperienceModalCommunity01 = ({ selectedExperince, showEditExperiencesModal01, setShowEditExperiencesModal01, showEditExperiencesModal02, setShowEditExperiencesModal02 }) => {

  const dispatch = useDispatch();

  const slectedProfileCommunity = useSelector((state) => state.community);
  ...
  const {admins} = slectedProfileCommunity
  ...
  return (
    ...
    <div className="flex flex-row flex-wrap w-full">
      <EditExperienceModalCommunity02
      ...
      <EditExperienceModalCommunityDelete
...
export default EditExperienceModalCommunity01;
