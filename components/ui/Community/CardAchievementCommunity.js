...
/* Components */
import AchievementModalCommunity from './AchievementModalCommunity';
...
const CardAchievementCommunity = ({ userId, username, image_profile, email, gamertag }) => {
...
export default CardAchievementCommunity;
