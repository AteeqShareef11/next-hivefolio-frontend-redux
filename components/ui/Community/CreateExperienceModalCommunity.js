...
const CreateExperienceModalCommunity = ({ showCreateExperienceModal, setShowCreateExperienceModal, selectedExperince}) => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append('data', JSON.stringify({name: name, description: description, related_communities: [selectedProfileCommunity], admins: [admins] }));
...
export default CreateExperienceModalCommunity;
