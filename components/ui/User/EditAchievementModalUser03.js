...
const EditAchievementModalUser03 = ({ setShowEditAchievementModal01, showEditAchievementModal03,  setShowEditAchievementModal03, showToast1, setShowToast1}) => {
  ...
  return (
    <div className="flex flex-row flex-wrap w-full">
          ...
          <IonModal
            isOpen={showEditAchievementModal03}
            swipeToClose={true}
            onDidDismiss={() => {
              setShowEditAchievementModal01(true), 
              setShowEditAchievementModal03(false)}
            }
            >
...
export default EditAchievementModalUser03;
