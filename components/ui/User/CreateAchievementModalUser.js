...
const CreateAchievementModalUser = ({ showCreateAchievementModal, setShowCreateAchievementModal, selectedAchievement}) => {
  ...
  const handleSubmit = async (event) => {
    ...
    dispatch(createAchievementUser(formData, setShowEditAchievementModal01, setShowCreateAchievementModal, setShowToastCreate, fetchAchievements, fetchUsers))
...
export default CreateAchievementModalUser;
