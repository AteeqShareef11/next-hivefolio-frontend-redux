...
import { organisationAddTeam } from '../../redux/actions/organisationActions';
import { createNotificationOrganisationTeamRequest } from '../../redux/actions/notificationActions';

const CardTeamListAddOrganisation = ({ teamId, name, image_profile, }) => {
...
const { id } = useParams();
  ...
  const organisation = useSelector(state => state.organisation)
    ...
    const [organisationDataTeam, setOrganisationDataTeam] = useState({})
    ...
    useEffect(()=>{
        ...
        .then(data => {
            ...
            setOrganisationDataTeam(data.data.teams)
        }).catch(err => {
            console.log("ERR: ", err)
        })
    ...
    /* const handleAddUser = async (event) => {
        ...
        dispatch(organisationAddTeam(id, teamId, teams, organisationDataTeam ))
    } */
...
export default CardTeamListAddOrganisation