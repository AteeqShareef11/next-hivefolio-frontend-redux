...
/* Components */
import ScoreModalOrganisation from './ScoreModalOrganisation';
import EditScoreModalOrganisation01 from './EditScoreModalOrganisation01';
...
const CardScoreOrganisation = ({ userId, username, image_profile, email, gamertag }) => {
      ...
      <div class="flex flex-row bg-light w-full px-6 py-4 whitespace-nowrap">
        <div class="flex justify-between items-center w-full">
          ...
          <div className='flex'>
            ...
            <ScoreModalOrganisation
              showModal={showModal}
              setShowModal={setShowModal}
            />

            <EditScoreModalOrganisation01
...
export default CardScoreOrganisation;
