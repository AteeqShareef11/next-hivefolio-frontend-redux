...
import { organisationAddCommunity} from '../../redux/actions/organisationActions';
import { createNotificationOrganisationCommunityRequest } from '../../redux/actions/notificationActions';

const CardCommunityListAddOrganisation = ({
    communityId, name, image_profile }) => {
    ...
    const [organisationDataCommunity, setOrganisationDataCommunity] = useState({})
    ...
    useEffect(()=>{
        ...
        .then(data => {
            ...
            setOrganisationDataCommunity(data.data.communities)
        }).catch(err => {
            console.log("ERR: ", err)
        })
    ...
    /* New Add community to members list */
    /* const handleAddUser = async (event) => {
        //event.preventDefault()
        dispatch(organisationAddCommunity(id, communityId, communities, organisationDataCommunity ))
    } */
...
export default CardCommunityListAddOrganisation