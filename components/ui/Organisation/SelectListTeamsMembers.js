...
/* Components */
import CardUserModalTeamOrganisation from './CardUserModalTeamOrganisation';
...
const getUsersData = async key => {
  ...
  const resUsers = await fetch(`https://hivefolio.herokuapp.com/api/organisations/${id}`);
