...
/* Components */
import ExperienceModalOrganisation from './ExperienceModalOrganisation';
import CreateExperienceModalOrganisation from './CreateExperienceModalOrganisation';
...
const CardExperienceOrganisation = ({ experience }) => {
      ...
      <div class="">
        <div className="flex flex-row">
          ...
          <div class="flex-shrink-0 h-10 ">
            {selectedExperince.image_profile ? (
              <div
                ...
                style={{
                  backgroundImage: `url(${selectedExperince.image_profile && selectedExperince.image_profile.url})`,
                }}
          ...
          <div class="flex flex-col ml-4">
            ...
            <div class="text-sm text-gray-500">{selectedExperince.type_experiences.name}</div>
          </div>
        </div>
...
export default CardExperienceOrganisation;
