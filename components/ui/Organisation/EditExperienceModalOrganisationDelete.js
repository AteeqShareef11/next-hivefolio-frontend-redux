...
const EditExperienceModalOrganisationDelete = ({ selectedExperince, showDeleteExperiencesModal, setShowEditExperiencesModal01, setShowDeleteExperiencesModal}) => {
...
export default EditExperienceModalOrganisationDelete;
