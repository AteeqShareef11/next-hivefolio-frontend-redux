...
const ExperienceModalOrganisation = ({ selectedExperince, showEditExperiencesModal, setShowEditExperiencesModal, showToast1, setShowToast1}) => {
...
export default ExperienceModalOrganisation;


const ModalContent = ({ description, type_experiences, selectedExperince, selectedProfileOrganisation, adminId, setShowEditExperiencesModal02 }) => {
  return (
    <>
