...
const CardUser = ({ id, image_profile, email, gamertag, username, games }) => {
    return (
            ...
            <IonCardContent>
                <Link to={`/user/${username}`} >
                    <div>
                        {image_profile ? (
                            <div
                                className="mx-auto bg-cover bg-no-repeat h-12 w-12 image-placeholder rounded-full"
                            ...
                            >
                                ...
                                <div
                                    className="mx-auto bg-cover bg-no-repeat h-12 w-12 image-placeholder rounded-full placeholder overflow-hidden text-transparent"
