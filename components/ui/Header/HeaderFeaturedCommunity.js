...
const HeaderFeaturedCommunity = ({community}) => {

    const {name, username, games, members, image_profile} = community.attributes
                ...
                <div className="relative w-full transform lg:my-4 xl:my-4 mx-12 space-y-6 h-full flex md:px-0 px-10 flex-col items-center justify-center">
                    ...
                    <ul className="flex space-x-7 xl:space-x-10">
                        ...
                        {image_profile && (
                            <li className="bg-white w-1/5 h-1/5 md:w-32 md:h-32 p-4 sm:p-5 md:p-7 rounded-full flex items-center justify-center shadow-xl">
                                {image_profile ? (
                                    <div className="mx-auto bg-cover bg-no-repeat image-placeholder rounded-full border-4 border-primary absolute
                                    xs:w-12 xs:h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-32 lg:h-32"
                                    style={{
                    ...
                    <ul className="flex items-center justify-center transform space-x-7 xl:space-x-10">
                        {members.data[2] && (
                            <li className="bg-white w-1/5 h-1/5 md:w-32 md:h-32 p-4 sm:p-5 md:p-7 rounded-full flex items-center justify-center shadow-xl">
                                {members.data[2].attributes.image_profile ? (
                                    ...
                                    xs:w-12 xs:h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-32 lg:h-32"
                                    style={{
                                        backgroundImage: `url(${members.data[2].attributes.image_profile && community.members.data[2].attributes.image_profile.data.attributes.url})`
                                        }}
                                        alt={`Profile name ${community.attributes.name}`}
                                >
                        ...
                        {community.attributes.members.data[3] && (
                            <li className="bg-white w-1/5 h-1/5 md:w-32 md:h-32 p-4 sm:p-5 md:p-7 rounded-full flex items-center justify-center shadow-xl">
                                {community.attributes.members.data[3].attributes.image_profile ? (
                                    <div className="mx-auto bg-cover bg-no-repeat image-placeholder rounded-full border-4 border-light absolute
                                    xs:w-12 xs:h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-32 lg:h-32"
                                    style={{
                                        backgroundImage: `url(${community.attributes.members.data[3].attributes.image_profile && community.members.data[3].attributes.image_profile.data.attributes.url})`
                                        }}
                                        alt={`Profile name ${community.attributes.name}`}
                                >
...
export default HeaderFeaturedCommunity