...
const HeaderShowcasePlayers = ({}) => {
    ...
    return (
        ...
        <div className='py-12 bg-light'>
            ...
            <div className='px-8'>
                <h1 className="mb-3 text-3xl font-bold leading-tight text-center text-gray-900 md:text-4xl">Join the Hivefolio community</h1>
                <p className="text-lg text-center text-gray-600 ">Build your brand, network and shape your esports career.</p>
            </div>
                                ...
                                users.sort(() => Math.random() - 0.5).map(user => (
                                    <li className="bg-white w-1/5 h-1/5 md:w-32 md:h-32 p-4 sm:p-5 md:p-7 rounded-full flex items-center justify-center shadow-xl">
                                        {user.image_profile ? (
                                            ...
                                            style={{
                                                backgroundImage: `url(${user.image_profile.url})`
                                                }}
...
export default HeaderShowcasePlayers