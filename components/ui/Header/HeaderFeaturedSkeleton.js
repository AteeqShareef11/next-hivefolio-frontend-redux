...
const HeaderFeaturedSkeleton = ({members}) => {
    ...
    return (
        <section className="flex flex-col mx-4 overflow-hidden bg-white lg:flex-row border-none rounded-3xl xs:flex-col-reverse sm:flex-col-reverse">
            <div className="flex flex-col space-y-2 justify-end p-8 bg-light lg:py-8 xs:pt-12 sm:pt-12 mb:pt-12 lg:px-16 lg:pl-10 lg:w-1/2 border-none relative">

                <div className="flex flex-wrap mb-4">
                    <div
                        className="inline-flex items-center justify-center w-20 h-12  
                        px-6 mr-2 mb-2 font-medium tracking-wide transition 
                        duration-200 bg-gray-400 animate-pulse rounded-full
                        focus:shadow-outline focus:outline-none absolute top-4 right-4"
                    >
                    </div>
                </div>

                <div className='xs:mt-4 sm:mt-4 mb:mt-4'>
                    <div className="flex flex-col space-y-2 items-start justify-center w-full ">
                        <div className="w-full h-8 rounded-full bg-gray-400 animate-pulse"></div>

                        <div className="pb-4 w-full h-4 rounded-full bg-gray-400 animate-pulse"></div>
            ...
            <div className="w-full relative flex items-center justify-center lg:py-0 py-10 lg:justify-start bg-gray-300">
                ...
                <div className="relative w-full transform lg:my-4 xl:my-4 mx-12 space-y-6 h-full flex md:px-0 px-10 flex-col items-center justify-center">
                    ...
                    <ul className="flex space-x-7 xl:space-x-10">
                        ...
                        <li className="bg-white w-1/5 h-1/5 md:w-32 md:h-32 p-4 sm:p-5 md:p-7 rounded-full flex items-center justify-center shadow-xl">
                            ...
                            <div className="mx-auto bg-cover bg-no-repeat h-28 w-28 image-placeholder rounded-full bg-gray-400 animate-pulse absolute
                            xs:w-12 xs:h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-32 lg:h-32"
                            >
                        ...
                        <li className="bg-white w-1/5 h-1/5 md:w-32 md:h-32 p-4 sm:p-5 md:p-7 rounded-md flex items-center justify-center shadow-xl">
                            ...
                            <div
                                className="mx-auto bg-cover bg-no-repeat image-placeholder rounded-md border-4 border-light animate-pulse absolute absolute
                                xs:w-12 xs:h-12 sm:w-16 sm:h-16 md:w-24 md:h-24 lg:w-32 lg:h-32"
...
export default HeaderFeaturedSkeleton